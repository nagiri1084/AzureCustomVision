...
public class ImageCapture : MonoBehaviour
{
    ...
    private void TapHandler(TappedEventArgs obj)
    {
        if (!captureIsActive)
        {
            ...
            SceneOrganiser.Instance.cameraCursor.GetComponent<Renderer>().material.color = Color.red;
    ...
    internal void ResetImageCapture()
    {
        ...
        SceneOrganiser.Instance.cameraCursor.GetComponent<Renderer>().material.color = Color.green;
